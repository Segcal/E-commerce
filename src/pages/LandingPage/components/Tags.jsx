...
export default function Tags() {
  return (
    <>
      <div className="text-gray-600 flex items-center justify-center capitalize md:gap-32 gap-10 bg-white lg:w-1/2 md:w-[80%] w-[95%]  mx-auto py-8 rounded-xl md:-mt-12 -mt-4 shadow-lg">
